...
if __name__ == "__main__":
    ...
    ax1.plot(res.index, ((1 + res["SP500"]).cumprod() - 1) * 100, label="S&P 500 Benchmark", color="black", linestyle="--", linewidth=1.5)
    ...
    plt.title("S&P 500 Backtest Results", fontsize=12, fontweight="bold", pad=15)
    plt.tight_layout()
